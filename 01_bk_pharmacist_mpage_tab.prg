...
; =============================================================================
; 1. GET MOST RECENT WEIGHT DOSING (Using Event Code 14516898.00)
; =============================================================================
...
; =============================================================================
; 2. QUERY GP MEDICATION DETAILS (DEBLOBBER LOGIC)
; =============================================================================
RECORD rec_blob (
  1 list[*]
    2 event_id = f8
...
PLAN CE WHERE CE.PERSON_ID = CNVTREAL($patient_id)
    AND CE.EVENT_CD = 25256529.00 ; Medication Details (GP)
...
; =============================================================================
; 3. MAIN MEDICATION QUERY (DUMMYT Anchor for Guaranteed Output)
; =============================================================================
...
HEAD REPORT
    ...
    ROW + 1 call print(concat("<span class='wt-label'>Last Dosing Weight:</span>"))
    ...
    DETAIL
        IF (ORDER_ID > 0)
            ...
            IF (
                ...
                call print(concat("<b>", MNEMONIC, "</b> <span style='color:red; font-size:10px; border:1px solid red; padding:0 3px;'>HELLO WORLD</span>"))
            ELSE
